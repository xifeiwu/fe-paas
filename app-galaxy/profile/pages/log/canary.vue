<template>
  <div id="log-canary">
    <div class="header">
      <paas-version-selector-non-production style="display: inline-block"
...
<script>
  import paasVersionSelectorNonProduction from '../components/version-selector-non-production';
  import paasDialogForLog from '../components/dialog4log.vue';
  import commonUtils from 'assets/components/mixins/common-utils';
  export default {
    mixins: [commonUtils],
    components: {paasVersionSelectorNonProduction, paasDialogForLog},
    created() {
      // set default service
...
//        const serviceVersion = serviceInfo ? serviceInfo.serviceVersion : '';
        ...
        this.requestCanaryDeployLogList();
      },

      requestCanaryDeployLogList(appId, profileId, serviceVersion) {
        ...
        this.$net.requestPaasServer(this.$net.URL_LIST.log_canary_deploy_list, {
          payload: {
            start, length,
          ...
          this.canaryDeployLogList = canaryDeployLogList;
          this.deployLogListByPage = this.canaryDeployLogList;
//          this.getDeployLogListByPage();
      ...
      getDeployLogListByPage() {
        ...
        this.deployLogListByPage = this.canaryDeployLogList.slice(start, end);
      },
