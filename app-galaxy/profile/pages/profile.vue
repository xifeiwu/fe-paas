...
//        console.log(this.routePathToConfig);
        ...
        if (this.routeConfig) {
          ...
          let pageNotShowGroupList = ['/profile/app/add', '/profile/service/add', '/profile/service/edit', '/profile/image/repo/version', '/profile/domain/white-list'];
      ...
      updateCrumbList(path) {
        ...
        ['profile/app', 'profile/service', 'profile/instance', 'profile/domain', 'profile/log', 'profile/work-order',
          'profile/monitor', 'profile/oauth', 'profile/config-server', 'profile/image/repo', 'profile/middleware/mariadb'].map(it => {
