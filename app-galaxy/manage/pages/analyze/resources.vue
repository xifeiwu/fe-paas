...
//          }]
    ...
    methods: {
      ...
      handleClick(action) {
        switch (action) {
          ...
          case 'download-analyze':
            ...
            this.$net.addToRequestingRrlList(downloadRequestDesc.path);
            this.$net.getResponse(downloadRequestDesc, {
              payload
            }, {
              headers: {
              ...
              this.$net.removeFromRequestingRrlList(downloadRequestDesc.path);
            });
            break;
        }
      },
      ...
      onDetailSortChangeInTable(tableSort) {
        ...
        const key = keyMap[tableSort.prop];
        if (!key) {
          return 0;
        }
